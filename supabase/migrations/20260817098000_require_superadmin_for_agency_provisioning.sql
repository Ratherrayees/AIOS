-- Align an already-applied local 970 migration with the final server-side
-- authority boundary. A platform admin can operate lifecycle controls but only
-- a superadmin may create a new tenant and its initial owner invitation.
