-- Atomic platform agency provisioning. The agency remains inaccessible in
-- `provisioning` until a reviewed lifecycle activation.
...
comment on function public.provision_organization_service(
  text, text, text, text, uuid, text
) is
  'Creates a provisioning agency and owner invitation atomically. Service role only.';
