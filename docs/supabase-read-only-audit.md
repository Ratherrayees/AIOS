...
- Local migration history now contains 77 migrations; the hosted database had applied 57 at the read-only checkpoint.
...
3. deploy the 20 pending migrations to a dedicated staging project, not directly to production;
