...
- Local migration history now contains 76 migrations; the hosted database had applied 57 at the read-only checkpoint.
...
3. deploy the 19 pending migrations to a dedicated staging project, not directly to production;
