...
The latest 1 August checkpoint restored 63 application tables with RLS, 172 policies, 326 indexes, 63 public functions, all 74 migrations through `20260801120000`, and representative organization, membership, and audit row counts. Source and restored evidence matched exactly. Backup plus restore completed in 12.7 seconds on the local workstation, and post-run inspection found no temporary database or dump.
