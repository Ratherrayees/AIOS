...
The latest 1 August checkpoint restored 63 application tables with RLS, 172 policies, 325 indexes, 62 public functions, all 73 migrations through `20260801110000`, and representative organization, membership, and audit row counts. Source and restored evidence matched exactly. Backup plus restore completed in 8.9 seconds on the local workstation, and post-run inspection found no temporary database or dump.
