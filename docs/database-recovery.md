...
The latest 1 August checkpoint restored 68 application tables with RLS, 177 policies, 348 indexes, 69 public functions, all 78 migrations through `20260801160000`, and representative organization, membership, and audit row counts. Source and restored evidence matched exactly. Backup plus restore completed in 6.5 seconds on the local workstation, and post-run inspection found no temporary database or dump.
