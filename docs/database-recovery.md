...
The latest 1 August checkpoint restored 62 application tables with RLS, 170 policies, 318 indexes, 61 public functions, all 72 migrations through `20260801100000`, and representative organization, membership, and audit row counts. Source and restored evidence matched exactly. Backup plus restore completed in 4.6 seconds on the local workstation, and post-run inspection found no temporary database or dump.
