...
The latest 1 August checkpoint restored 69 application tables with RLS, 177 policies, 357 indexes, 73 public functions, all 79 migrations through `20260801170000`, and representative organization, membership, and audit row counts. Source and restored evidence matched exactly. Backup plus restore completed in 4.7 seconds on the local workstation, and post-run inspection found no temporary database or dump.
