...
The latest 1 August checkpoint restored 64 application tables with RLS, 173 policies, 328 indexes, 64 public functions, all 75 migrations through `20260801130000`, and representative organization, membership, and audit row counts. Source and restored evidence matched exactly. Backup plus restore completed in 10.8 seconds on the local workstation, and post-run inspection found no temporary database or dump.
