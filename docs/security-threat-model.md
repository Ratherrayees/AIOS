...
| --- | --- | --- |
| Cross-tenant read/write | RLS on 71 application tables, active-membership helpers, immutable `organization_id`, same-tenant composite foreign keys, 346 owner/viewer/service authorization assertions | Repeat the complete probe against staging and production-like identities |
