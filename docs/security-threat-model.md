...
| --- | --- | --- |
| Cross-tenant read/write | RLS on 77 application tables, active-membership helpers, immutable `organization_id`, same-tenant composite foreign keys, 407 owner/viewer/operations/service authorization assertions | Repeat the complete probe against staging and production-like identities |
